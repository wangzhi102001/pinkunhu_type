        ...
        try:
            ...
            if (p1.edit == False and p1.error == False):
                ...
                try:
                    ...
                    ff.retryingFindClick(my.xpath11,driver)  #点击第一栏查询项姓名栏（如果查询结果唯一）
                    time.sleep(1)
            ...
            try:
                ...
                pass
            try:
                driver.find_element_by_xpath(my.xpath36).click()#添加修改帮扶日期页面关闭X按钮
            except :
                pass
